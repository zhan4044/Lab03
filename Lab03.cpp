...
void firstChoice(float A, float B) {
	cout << "This is proving the first choice ran: " << A+B << endl;
}
void secondChoice(float A, float B) {
	cout << "This is proving the second choice ran: " << A-B << endl;
}
void thirdChoice(float A, float B) {
	cout << A << "*" << B << "= " << A * B << endl;
}
void fourthChoice(float A, float B) {
	cout << "This is proving the fourth choice ran: " << A/B << endl;
}
int main() {
	int choice;
	float A;
